...
class RestaurantAdapter(val rests: List<Restaurant>, val context: Context): RecyclerView.Adapter<RestaurantAdapter.MyViewHolder>(){
    ...
    class MyViewHolder(view: View, listener: onItemClickListener):RecyclerView.ViewHolder(view){
        val name = view.findViewById<TextView>(R.id.restName)
        val desc = view.findViewById<TextView>(R.id.desc)
        val img = view.findViewById<ImageView>(R.id.restImg)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val imageId = context.resources.getIdentifier(rests[position].logo, "drawable", context.packageName)
